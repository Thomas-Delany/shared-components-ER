                ...
                <div class="row g-lg-5 mt-3">
                    ...
                    <div class="col-sm-4 col-lg-4 text-center position-relative">
                        ...
                        <div class="px-4">
                            ...
                            <!-- Title -->
                            <h3>Explanation</h3>
                            <p class="lead">Here we begin the process. A short and concise explanation is given,
                                detailing the rules on how and why we use the newly learned grammar point.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 col-lg-4 text-center pt-0 pt-lg-5 position-relative">
                        ...
                        <div class="px-4">
                            ...
                            <!-- Title -->
                            <h3>Context</h3>
                            <p class="lead">This is where the magic begins! The new grammar point is put into action,
                                that is, a dialogue or text where what has just been learned is used. There is no use
                                just reading a rule with examples and then trying to remember it. You need to see it in
                                a real dialogue or context.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 col-lg-4 text-center">
                        <div class="px-4">
                            ...
                            <!-- Title -->
                            <h3>Analysis</h3>
                            <p class="lead">Inside the dialogue or text, you will find a lot of superscripts or small
                                numbers. (4,7,1,4, etc.) These small numbers will be displayed on top of some words in
                                the dialogue or text that need some particular clarification.
                            </p>
                        </div>
                    </div>
                </div>
