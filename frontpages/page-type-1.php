                ...
                <div class="row g-lg-5 mt-3">
                    ...
                    <div class="col-sm-4 col-lg-4 text-center position-relative">
                        ...
                        <div class="px-4">
                            ...
                            <!-- Title -->
                            <h3>Method</h3>
                            <p class="lead">Everything is taught in an especially inductive manner with context and
                                dialogue whilst implementing our method of instruction: explanation — context —
                                analysis.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 col-lg-4 text-center pt-0 pt-lg-5 position-relative">
                        ...
                        <div class="px-4">
                            ...
                            <p class="lead">Each course is a compilation of videos with more than 3 hours of content.
                                Each video lasts between 5 - 13 minutes. There is a Section Review after every lesson.
                                These section reviews are multiple-choice.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 col-lg-4 text-center">
                        <div class="px-4">
                            ...
                            <!-- Title -->
                            <h3>In a nutshell</h3>
                            <p class="lead">Our English courses have more than 3 hours of content. Log in to stream your
                                course online. Narrated in Spanish (the language of instruction is Spanish).</p>
                        </div>
                    </div>
                </div>
                <!-- Steps END -->
            ...
            <div class="container position-relative py-5">
                ...
                <div class="row">
                    <div class="col-lg-8 mb-4">
                        <h2>All your Courses in one Bundle</h2>
                    </div>
                </div>
