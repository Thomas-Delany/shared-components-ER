				...
				<div class="row align-items-center g-5">
					...
					<div
						...
						<div class="d-lg-flex align-items-center justify-content-center justify-content-lg-start pt-4 pt-lg-2">
							<!-- Button -->
							<a href="#" class="btn btn-success btn-lg me-2 mb-4 mb-lg-0 w-75 w-xl-auto font-dosis fs-5 fw-bolder">Level Test</a>
							<a href="#" class="btn btn-light border border-success btn-lg me-2 mb-4 mb-lg-0 w-75 w-xl-auto font-dosis fs-5 fw-bolder">Log in</a>
						</div>
					</div>
					<!-- Left content END -->
					...
					<div class="d-none d-lg-block col-lg-5 col-xl-5 text-center mx-auto position-relative pt-md-5">
						<!-- Image -->
						<div class="text-end">
							<img src="<?php echo BASE_URL; ?>central/assets/images/element/category-2.svg" class="w-75 text-end" alt="cursos de ingles">
						</div>
					</div>
					<!-- Right content END -->
				</div>
