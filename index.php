			...
			<div class="container">
				...
				<div class="row align-items-center g-5">
					...
					<div
						...
						<!-- Title -->
						<h1 class="mb-0 display-6 pt-4 font-dosis custom-line-height custom-title-header text-center">Aprender inglés al alcance de tu
							<span class="position-relative custom-line-height">Manos!
								<!-- SVG START -->
						...
						<!-- Content -->
						<p class="d-none text-center d-lg-block font-dosis my-4 fs-4 fw-medium">¡Aprende inglés con estructura, interactividad y diversión!</p>
					...
					<div class="d-none d-lg-block col-lg-5 col-xl-5 text-center mx-auto position-relative pt-md-5">
						<!-- Image -->
						<div class="text-end">
							<img src="assets/images/element/category-2.svg" class="w-75 text-end" alt="cursos de ingles">
						</div>
					</div>
					<!-- Right content END -->
